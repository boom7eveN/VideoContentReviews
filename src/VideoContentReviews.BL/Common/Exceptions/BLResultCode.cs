...
namespace VideoContentReviews.BL.Common.Exceptions;

public enum BLResultCode
{
    [Description("User not found.")] UserNotFound = 001,

    [Description("User already exists.")] UserAlreadyExists = 002,
    ...
    [Description("Validation error.")] ValidationError = 006,
    ...
    [Description("Director not found.")] DirectorNotFound = 009,
    ...
    [Description("Image already exists.")] ImageAlreadyExists = 012,

    [Description("Genre already exists.")] GenreAlreadyExists = 013,

    [Description("VideoContent already exists.")]
    VideoContentAlreadyExists = 014,
    [Description("Image not found.")] ImageNotFound = 015,
    [Description("Genre not found.")] GenreNotFound = 016,
}